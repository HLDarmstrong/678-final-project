...
###Data Preprocessing
The data set come from (https://www.kaggle.com/datasets/drgilermo/nba-players-stats), which has the Season stats from many different aspects, such ass Three point field goals, 2 points goal and 
